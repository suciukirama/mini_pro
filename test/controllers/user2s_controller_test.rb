...
class User2sControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user2" do
    assert_difference('User2.count') do
      post user2s_url, params: { user2: { email: @user2.email, id: @user2.id, name: @user2.name } }
    end
  ...
  test "should update user2" do
    patch user2_url(@user2), params: { user2: { email: @user2.email, id: @user2.id, name: @user2.name } }
